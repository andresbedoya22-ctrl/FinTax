    ...
    <div className="space-y-6" aria-live="polite" aria-busy="true">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-xl border border-border/35 bg-surface/35 p-4">
      ...
      <div className="grid gap-5 xl:grid-cols-3">
        <div className="xl:col-span-2 rounded-xl border border-border/35 bg-surface/35 p-5">
...
export function WizardPageSkeleton({ label }: { label: string }) {
  return (
    <div className="space-y-6" aria-live="polite" aria-busy="true">
      ...
      <div className="rounded-xl border border-border/35 bg-surface/35 p-5">
    ...
    <div className="space-y-6" aria-live="polite" aria-busy="true">
      ...
      <div className="grid gap-4 xl:grid-cols-[11fr_9fr]">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="rounded-xl border border-border/35 bg-surface/35 p-5">
