...
import type { BenefitStepKey } from "./wizard";

export function BenefitsProgressHeader({
  currentStep,
  steps,
}: {
  currentStep: number;
  steps: readonly BenefitStepKey[];
}) {
    ...
    <div className="space-y-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="min-w-0 rounded-[24px] border border-border/45 bg-[linear-gradient(180deg,rgba(251,252,249,0.96),rgba(244,247,242,0.82))] px-4 py-4 lg:w-[23rem]">
          ...
          <div className="mt-3 h-2 overflow-hidden rounded-full bg-surface2/80" data-testid="benefits-progress-bar">
            <div
              className="h-full rounded-full bg-[linear-gradient(90deg,#1f6a47,#c58f43)]"
